...
class QuizzleManager: ObservableObject {
    ...
    func fetchTrivia() async {
        guard let url = URL(string: "http://localhost:3004/questions") else { fatalError("Missing URL") }
        ...
        do {
            ...
            DispatchQueue.main.async {
                ...
                self.trivia = Array(decodedData.shuffled().prefix(10))
